...
def normalize_waveform(df):

    df['norm_waveform'] = df['waveform'].copy()

    

def label_spike_waveform(data=None, savedir=None, sd=None):
    """
    `data` is a series (col of dataframe) that contains waveform data. each index is a cell
